// Minimal inline icon set (24×24, 1.75 stroke). Decorative by default.
const PATHS = {
  ...
  megaphone: 'M3 10v4a1 1 0 0 0 1 1h3l6 4V5L7 9H4a1 1 0 0 0-1 1Zm14-2a5 5 0 0 1 0 8',
  certificate: 'M6 3h12a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Zm3 5h6m-6 3h4m1 4v6l2-1.5 2 1.5v-6',
  ...
  eyeOff: 'M3 3l18 18M10.6 5.6A9.7 9.7 0 0 1 12 5.5c6 0 9.5 6.5 9.5 6.5a17 17 0 0 1-3 3.8M6.6 6.6C3.9 8.3 2.5 12 2.5 12S6 18.5 12 18.5c1.8 0 3.3-.5 4.6-1.2M9.9 9.9a3 3 0 0 0 4.2 4.2',
};

export default function Icon({ name, size = 20, className = '', label, strokeWidth = 1.75 }) {
  return (
    <svg
      width={size}
      height={size}
